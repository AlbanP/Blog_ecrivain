			...
			<div class="margTop15 borderTop">
				<?php foreach ($listPost as $post) { ?>
                    <div class="borderBot margTop15">
                        ...
                        <?php if (is_null($post['orderPosted'])) {
                        	echo '<span class="label label-info margLeft15">Brouillon</span>';
                            } else {
                        	echo '<span class="label label-success margLeft15">Publié</span>'; } ?>
